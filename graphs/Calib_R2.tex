...
\draw [anchor= west] (4.02865,10.1791) node[scale=1.20912, color=c, rotate=0]{p0       };
\draw [anchor= east] (10.5272,10.1791) node[scale=1.20912, color=c, rotate=0]{$ 0.2626 \pm   8.3$};
\draw [anchor= west] (4.02865,9.10458) node[scale=1.20912, color=c, rotate=0]{p1       };
...
\draw [anchor= west] (4.02865,9.10458) node[scale=1.20912, color=c, rotate=0]{p1       };
\draw [anchor= east] (10.5272,9.10458) node[scale=1.20912, color=c, rotate=0]{$ 0.1092 \pm 0.0008818$};
\draw (9.25501,12.7221) node[scale=1.40004, color=c, rotate=0]{Calibrazione R2};
\end{tikzpicture}
